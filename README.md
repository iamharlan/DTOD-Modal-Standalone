...
<script type="text/javascript">
	...
	var pc_modalactivation = "enabled"; // Enables the modal. Change to "disabled" to remove auto triggering. Sticky button will still trigger modal.
